...
class User(Base):
    ...
    budget_lines: Mapped[list["BudgetLine"]] = relationship(back_populates="user", cascade=_CASCADE_ALL_DELETE_ORPHAN)
    budget_settings: Mapped[Optional["BudgetSettings"]] = relationship(back_populates="user", cascade=_CASCADE_ALL_DELETE_ORPHAN, uselist=False)
    budget_month_notes: Mapped[list["BudgetMonthNote"]] = relationship(back_populates="user", cascade=_CASCADE_ALL_DELETE_ORPHAN)
    personal_debts: Mapped[list["PersonalDebt"]] = relationship(back_populates="user", cascade=_CASCADE_ALL_DELETE_ORPHAN)
