...
class User(Base):
    ...
    overseas_consent_at: Mapped[Optional[datetime]] = mapped_column(
        TIMESTAMP(timezone=True), nullable=True
    )
    terms_accepted_at: Mapped[Optional[datetime]] = mapped_column(
        TIMESTAMP(timezone=True), nullable=True
    )
    kvkk_read_at: Mapped[Optional[datetime]] = mapped_column(
        TIMESTAMP(timezone=True), nullable=True
    )
    ...
    anthropic_consent_at: Mapped[Optional[datetime]] = mapped_column(
        TIMESTAMP(timezone=True), nullable=True
    )
    ...
    email_change_expires_at: Mapped[Optional[datetime]] = mapped_column(
        TIMESTAMP(timezone=True), nullable=True
    )
    ...
    investment_advice: Mapped[list["InvestmentAdvice"]] = relationship(
        back_populates="user", cascade="all, delete-orphan"
    )
    tefas_holdings: Mapped[list["TefasHolding"]] = relationship(
        back_populates="user", cascade="all, delete-orphan"
    )
    stock_holdings: Mapped[list["StockHolding"]] = relationship(
        back_populates="user", cascade="all, delete-orphan"
    )
    bes_holdings: Mapped[list["BesHolding"]] = relationship(
        back_populates="user", cascade="all, delete-orphan"
    )
    ...
    commodity_holdings: Mapped[list["CommodityHolding"]] = relationship(
        back_populates="user", cascade="all, delete-orphan"
    )
    ...
    manual_crypto_holdings: Mapped[list["ManualCryptoHolding"]] = relationship(
        back_populates="user", cascade="all, delete-orphan"
    )
