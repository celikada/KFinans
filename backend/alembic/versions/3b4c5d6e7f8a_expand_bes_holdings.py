...
def upgrade() -> None:
    ...
    op.add_column(
        "bes_holdings",
        sa.Column("paid_returns", sa.Numeric(18, 2), nullable=False, server_default="0"),
    )
    op.add_column(
        "bes_holdings",
        sa.Column("govt_contribution", sa.Numeric(18, 2), nullable=False, server_default="0"),
    )
    op.add_column(
        "bes_holdings",
        sa.Column("govt_returns", sa.Numeric(18, 2), nullable=False, server_default="0"),
    )
