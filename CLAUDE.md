...
- **Migration head:** `c9d0e1f2a3b4` (çoklu para birimi omurgası, 2026-06-04). v0.3.1 (görüntüleme para birimi, realize/skip geri alma) ve v0.3.2 (release-notes otomasyonu: `admin_emails`/`release_notes_token` config + login bootstrap) **migration İÇERMEZ** — yalnızca kod/endpoint/config. Yeni migration `down_revision = "c9d0e1f2a3b4"`. Zincir: `f3a4b5c6d7e8` (kredi ledger) → `a7b8c9d0e1f2` (recurring_skips) → `b8c9d0e1f2a3` (sürüm bildirimi opt-in) → `c9d0e1f2a3b4` (çoklu para birimi, **prod head**).
